                ...
                <table className="table table-bordered table-hover">
                    ...
                    {users.map((user,i)=>{
                        return  (<tr key={i}>
                                    ...
                                    <td><button className="btn btn-warning" onClick={()=>{this.editUser(user)}}>Modifier</button></td>
                                    <td><button className="btn btn-danger" onClick={()=>{this.delete(user.id)}} >Supprimer</button></td>
                                </tr>);
                    })}
                    </tbody>
