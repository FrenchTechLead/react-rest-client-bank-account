                ...
                <div className="col-xs-12 col-md-3">
                    <div className="list-group" style={{"cursor":"pointer"}}>
                        <a onClick={() => { this.operationsView() }} className="list-group-item active" id="operations">
                            <h4 className="list-group-item-heading"><i className="fa fa-money" aria-hidden="true"></i> Mes Opérations</h4>
                        </a>
                        <a onClick={() => { this.monCompteView() }} className="list-group-item" id="mon-compte">
                            <h4 className="list-group-item-heading"><i className="fa fa-line-chart " aria-hidden="true"></i> Mon Compte</h4>
                        </a>
                        <a onClick={() => { this.virementView() }} className="list-group-item" id="virement">
                            <h4 className="list-group-item-heading"><i className="fa fa-exchange" aria-hidden="true"></i> Faire un virement</h4>
                        </a>
                        <a onClick={() => { this.informationsView() }} className="list-group-item" id="informations">
                            <h4 className="list-group-item-heading"><i className="fa fa-user-o" aria-hidden="true"></i> Mes Informations</h4>
                        </a>
                    </div>
