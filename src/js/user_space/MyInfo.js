        ...
        return(
            <form onSubmit={this.handleSubmit}>
                <div className="col-sm-offset-4 col-sm-4">
                    ...
                    <br/>
                    <label>Name:</label>
                    <input className="form-control" disabled placeholder="seulement un admin peut changer votre nom" /><br/>
                    <label>Email:</label>
                    ...
                    <button className="btn-block btn-default" type="submit">Modifier</button>
                </div>
            </form>);
    }
}